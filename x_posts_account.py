...
def run_scheduler():
    schedule.every().day.at("00:30").do(create_and_post)
    schedule.every().day.at("01:00").do(create_and_post)
    schedule.every().day.at("01:30").do(create_and_post)
    schedule.every().day.at("02:00").do(create_and_post)
    schedule.every().day.at("02:30").do(create_and_post)
    schedule.every().day.at("03:00").do(create_and_post)
    schedule.every().day.at("03:30").do(create_and_post)
    schedule.every().day.at("04:00").do(create_and_post)
    schedule.every().day.at("04:30").do(create_and_post)
    schedule.every().day.at("05:00").do(create_and_post)
    schedule.every().day.at("05:30").do(create_and_post)
    schedule.every().day.at("06:00").do(create_and_post)
    schedule.every().day.at("06:30").do(create_and_post)
    schedule.every().day.at("07:00").do(create_and_post)
    schedule.every().day.at("07:30").do(create_and_post)
    schedule.every().day.at("08:00").do(create_and_post)
    schedule.every().day.at("08:30").do(create_and_post)
    schedule.every().day.at("09:00").do(create_and_post)
    schedule.every().day.at("09:30").do(create_and_post)
    schedule.every().day.at("10:00").do(create_and_post)
    schedule.every().day.at("10:30").do(create_and_post)
    schedule.every().day.at("11:00").do(create_and_post)
    schedule.every().day.at("11:30").do(create_and_post)
    schedule.every().day.at("12:00").do(create_and_post)
    schedule.every().day.at("12:30").do(create_and_post)
    schedule.every().day.at("13:00").do(create_and_post)
    schedule.every().day.at("13:30").do(create_and_post)
    schedule.every().day.at("14:00").do(create_and_post)
    schedule.every().day.at("14:30").do(create_and_post)
    schedule.every().day.at("15:00").do(create_and_post)
    schedule.every().day.at("15:30").do(create_and_post)
    schedule.every().day.at("16:00").do(create_and_post)
    schedule.every().day.at("16:30").do(create_and_post)
    schedule.every().day.at("17:00").do(create_and_post)
    schedule.every().day.at("17:30").do(create_and_post)
    schedule.every().day.at("18:00").do(create_and_post)
    schedule.every().day.at("18:30").do(create_and_post)
    schedule.every().day.at("19:00").do(create_and_post)
    schedule.every().day.at("19:30").do(create_and_post)
    schedule.every().day.at("20:00").do(create_and_post)
    schedule.every().day.at("20:30").do(create_and_post)
    schedule.every().day.at("21:00").do(create_and_post)
    schedule.every().day.at("21:30").do(create_and_post)
    schedule.every().day.at("23:00").do(create_and_post)
    log("[Scheduler] 45 posts/day scheduled.")
    while True:
